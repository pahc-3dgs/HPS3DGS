"""Runtime guards: torch-2.x render incompatibility note for the HAC++ driver."""
...
class Torch2RenderGuardTest(unittest.TestCase):
    def test_warning_records_the_evidence(self):
        for needle in ("25.17 GiB", "zxa1-12_init", "voxel_size 0.001", "1.12.1"):
